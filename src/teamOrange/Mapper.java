...
public class Mapper {
    ...
    // Serial Type Codes
    static final byte typeCodeNull1B = 0x00;
    static final byte typeCodeNull2B = 0x01;
    static final byte typeCodeNull4B = 0x02;
    static final byte typeCodeNull8B = 0x03;
    static final byte typeCodeTinyInt = 0x04;
    static final byte typeCodeSmallInt = 0x05;
    static final byte typeCodeInt = 0x06;
    static final byte typeCodeBigInt = 0x07;
    static final byte typeCodeReal = 0x08;
    static final byte typeCodeDouble = 0x09;
